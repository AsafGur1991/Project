 ...
 *
 */
public class CouponSqlQuerys implements Serializable
{
	public static String COUPON_ID_BY_COMP_ID = "SELECT coupon_id FROM couponsystem.company_coupon WHERE comp_id = '%1s'";
	public static String COUPON_ID_BY_COMP_ID_AND_COUPON_ID = "SELECT coupon_id FROM couponsystem.company_coupon WHERE comp_id = '%1s' and coupon_id = '%2s'";
