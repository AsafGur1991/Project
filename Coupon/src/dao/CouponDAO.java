...
public interface CouponDAO
{
	 ...
	 * @throws InterruptedException thrown when the thread is interrupted - might be because the system is shutting down
	 * @throws NullConnectionException thrown when the connection is null
	 * @throws WrongEntryException thrown when entry does not exist in the database
	 * @throws UnAuthorizedAction thrown when a company-user tries to change a coupon that is not his
	 */
	 ...
	 * @throws NullConnectionException thrown when the connection is null
	 * @throws WrongEntryException thrown when entry does not exist in the databas
	 * @throws UnAuthorizedAction thrown when a company-user tries to change a coupon that is not his
	 */
