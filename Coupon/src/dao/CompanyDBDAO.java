...
public class CompanyDBDAO implements CompanyDAO,Serializable
{
	 ...
	 */
	@Override
	public void removeComapny(Company company) throws ClassNotFoundException, InterruptedException, SQLException, NullConnectionException, WrongEntryException
	{
		//establishing the connection to the data base
		Connection con = (Connection) ConnectionPool.getInstance().getConnection();
		...
		{
			throw new WrongEntryException("the admin tried to remove a company that does not exist in the datbase");
	...
	public void updateCompany(Company company) throws ClassNotFoundException, InterruptedException, SQLException, NullConnectionException, WrongEntryException
	{
		...
		{
			throw new WrongEntryException("the admin tried to update a company that does not exist in the datbase");			
		}
	}
