...
public class maintest {
	...
	public static void main(String[] args) throws ParseException, ClassNotFoundException, SQLException, InterruptedException, WrongDataInputException, NullConnectionException, DuplicateEntryException, WrongEntryException, UnAuthorizedAction {
		...
		Customer cust1 = new Customer(9,"jsons","123456");
		...
		companyfacade = (CompanyFacade) CouponSystem.getInstance().login("bezeq", "123456", ClientType.COMPANY);
		String test = "18-05-30";
		java.util.Date date = DateTranslate.stringToDate(test);
		System.out.println(companyfacade.getCouponByDate(date));
		/*Coupon coup1 = new Coupon(0, "ccc", "17-01-01", "17-01-29", 5,CouponType.camping, "hhh", 25.7,"ttt");
